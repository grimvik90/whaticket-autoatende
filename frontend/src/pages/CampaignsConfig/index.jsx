            ...
            <Grid xs={12} md={4} item>
              ...
              >
                <InputLabel id="messageInterval-label">
                  Intervalo mínimo de disparos
                </InputLabel>
                <Select
                  name="messageInterval"
                  id="messageInterval"
                  labelId="messageInterval-label"
                  label="Intervalo minimo de Disparo"
            ...
            <Grid xs={12} md={4} item>
              ...
              >
                ...
                >
                  ...
                  <MenuItem value={10}>10 envios</MenuItem>
                  <MenuItem value={15}>15 envios</MenuItem>
                  <MenuItem value={20}>20 envios</MenuItem>
                  <MenuItem value={30}>30 envios</MenuItem>
                  <MenuItem value={40}>40 envios</MenuItem>
                  <MenuItem value={60}>60 envios</MenuItem>
                  <MenuItem value={80}>80 envios</MenuItem>
                  <MenuItem value={100}>100 envios</MenuItem>
                  <MenuItem value={120}>120 envios</MenuItem>
                </Select>
              </FormControl>
            </Grid>
            <Grid xs={12} md={4} item>
