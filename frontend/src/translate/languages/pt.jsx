    ...
    translations: {
      ...
      connections: {
        ...
        toolTips: {
          edit: "Editar",
            delete: "Excluir",
          forceDelete: "Excluir junto com todos atendimentos",
        ...
        updateImage: "A sessão foi reiniciada, por favor, leia o QRCode novamente!",
        table: {
          name: "Nome",
          status: "Status",
          number: "Número",
      ...
      qrCode: {
        ...
        title: "Conectando com seu WhatsApp:",
      ...
      optionsPage: {
        ...
        aceptcall: "Chamadas de Voz e Vídeo",
        ...
        buttons: {
          ...
          partner: "Empresa",
          act: "Ativado",
          desact: "Enviar mensagem de indisponível",
          callok: "Aceitar chamadas",
          calldeny: "Ignorar",
        },
      },
      daysweek: {
