...
const WhatsAppModal = ({open, onClose, whatsAppId}) => {
    ...
    const handleChangePrompt = (e) => {
        ...
        setSelectedPrompt(value === "0" ? null : value);
    };

    const handleChangeIntegrationId = (e) => {
        const value = e.target.value;
        setSelectedIntegration(value === "0" ? null : value);
    };
    ...
    const handleSaveWhatsApp = async (values) => {
        ...
        try {
            if (whatsAppId) {
                if (whatsAppId && enableImportMessage) {
                    toast.warning(
                        i18n.t("connections.updateImage"),
                        {autoClose: false}
                    );
                    try {
                                        ...
                                        />
                                            ...
                                            >
                                                ...
                                                <Field
                                                    ...
                                                    name="integrationId"
                                                    id="integrationId"
                                                    value={selectedIntegration || "0"} // Mantém o valor padrão como "0"
                                            ...
                                            >
                                                ...
                                                <Select
                                                    ...
                                                    name="promptId"
                                                    variant="outlined"
                                                    value={selectedPrompt || "0"} // Mantém o valor padrão como "0"
