...
const VcardPreview = ({ contact, numbers, comandoAdicional }) => {
				...
				<Grid container spacing={1}>
					<Grid item xs={2}>
						<Avatar
                            ...
                            src={contactWithPhoneNumber ? contactWithPhoneNumber.profilePicUrl : ''} />
					</Grid>
					<Grid item xs={9}>
					...
					<Grid item xs={12}>
		                ...
		                {comandoAdicional === '<br>' && (
		                    <>
		                        ...
		                        <Grid item xs={12} style={{ borderTop: "dotted #b0a8a8" }}>
		                            <br />
		                        </Grid>
		                    </>
		                )}
