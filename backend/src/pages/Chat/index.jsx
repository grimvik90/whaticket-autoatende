...
import { useMediaQuery } from "@mui/material"; // Adicione esta importação
...
function Chat(props) {
  ...
  const isWideScreen = useMediaQuery((theme) => theme.breakpoints.up('md')); // Use useMediaQuery para verificar a largura
  ...
  return (
    <>
      ...
      <Paper className={classes.mainContainer}>
        {isWideScreen ? renderGrid() : renderTab()} 
      </Paper>
    </>
  );
}
