...
import {PlayArrow, Pause, VolumeUp, GetApp, MoreVert} from '@mui/icons-material';
...
const CustomAudioPlayer = ({src, onPlay}) => {
    ...
    return <>
        {isIOS && (
            <Box className="ogv-audio-player" p={2} bgcolor="background.paper" borderRadius="8px" boxShadow={1}>
