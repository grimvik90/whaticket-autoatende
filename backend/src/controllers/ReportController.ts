...
const ReportController = {
  tickets: async (req: Request, res: Response) => {
    ...
    let { dateStart, dateEnd, status, queueId, reasonId } = req.body;
    ...
    let tickets = await Ticket.findAll({
      ...
      attributes: ["id", "createdAt", "status", "queueId", "userId", "contactId","reasonId"],
    ...
    for (let ticket of tickets) {
      ...
      parsedTickets.push({
        ...
        reasonId: tracking?.reasonId,
        reasonName: tracking?.reason?.name || "N/A",
